                ...
                <div className="bg-white rounded-2xl shadow-xl p-8 lg:p-10">
                    ...
                    <>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div>
                                <button type="submit" disabled={isSubmitting} className={`w-full flex justify-center items-center py-4 px-6 border border-transparent rounded-lg shadow-sm text-lg font-medium text-white ${isSubmitting ? 'bg-[#4a5a41]' : 'bg-[#58684f] hover:bg-[#4a5a41]'}  transition`}>
                                    {isSubmitting ? (
                                        <>
                ...
                <div className="flex flex-col">
                    <div className="bg-white rounded-2xl shadow-xl p-8 lg:p-10 h-full">
                        <div className="mb-10">
                            ...
                            <p className="text-gray-700 mb-8">En GeniaArte, nos especializamos en crear artículos únicos que reflejen tu estilo y personalidad. Desde camisetas hasta tazas y regalos corporativos, hacemos realidad tus ideas.</p>
                            
                            <div className="space-y-6">
                                <div className="flex items-start">
                                    <div className="shrink-0 bg-green-100 p-3 rounded-lg">
                                        <Phone className="w-6 h-6 text-[#58684f]" />
                                    </div>
                                    <div className="ml-4">
                                ...
                                <div className="flex items-start">
                                    <div className="shrink-0 bg-green-100 p-3 rounded-lg">
                                        <Mail className="w-6 h-6 text-[#58684f]" />
                                    </div>
                                    <div className="ml-4">
                                        <h3 className="text-lg font-medium text-gray-900">Email</h3>
                                        <p className="text-gray-600">contacto@geniaarte.com</p>
                                ...
                                <div className="flex items-start">
                                    <div className="shrink-0 bg-green-100 p-3 rounded-lg">
                                        <MapPin className="w-6 h-6 text-[#58684f]" />
                                    </div>
                                    <div className="ml-4">
                                        <h3 className="text-lg font-medium text-gray-900">Dirección</h3>
                                        <p className="text-gray-600">Calle Principal 123, Local 45</p>
